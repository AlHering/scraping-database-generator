...
def run_frontend(host: str = None, port: int = None, reload: bool = True) -> None:
    """
    Function for running frontend server.
    ...
    """
    app.run_server(host="127.0.0.1" if host is None else host,
                   port=int(
